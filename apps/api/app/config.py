...
class Settings:
    ...
    min_quote_volume_usd: float = float(os.getenv("WINLONG_MIN_QUOTE_VOLUME_USD", "10000000"))
    min_market_cap_usd: float = float(os.getenv("WINLONG_MIN_MARKET_CAP_USD", "50000000"))
